...
class  UserProfile extends React.Component {
 ...
 emailChangeHandler=(e)=> {
    ...
    fetchuserRecords=(user_id)=>{
        axios.get("https://sleepy-lowlands-65298.herokuapp.com/userapi/getUserDetails/"+user_id,
        { headers: {
    ...
    onProfileUpdate = (e) => { 
       ...
       // console.log(formData);
        ...
        axios.post("https://sleepy-lowlands-65298.herokuapp.com/userapi/updateProfile", formData,config).then((response) => {
...
render(){
    if(this.state.profileimage){
        ...
        var profileImage="https://sleepy-lowlands-65298.herokuapp.com/"+imagePath;
    }else{
